...
- start: 00:00:00
  title: Intro
- start: 00:00:54
  title: Wolfgangs Weltreise und Duisburg's Binnenhafen, der größte der Welt
- start: 00:04:16
  title: "Das heutige Thema: Docker - Was ist das? Woher kommt es? Sind Docker und Container dasselbe? Und wie sieht das Container-Ecosystem eigentlich aus"
- start: 00:08:11
  title: Wie lange gibt es Docker bereits? Und welches Problem löst Docker eigentlich?
- start: 00:16:47
  title: Was ist der Unterschied zwischen Virtual Machines (VMs) und Jar's zu Docker Containern?
- start: 00:21:41
  title: Wann und Wie entstand die Continuous Integration (CI) / Continuous Delivery (CD) / Continuous Deployment (CD) Bewegung?
- start: 00:24:38
  title: Was ist eigentlich ein Container im Sinne der Software?
- start: 00:29:32
  title: Change root (chroot)
- start: 00:31:20
  title: Was ist denn das Besondere an Docker, wenn es Linux Container bereits vorher gab?
- start: 00:39:20
...
- start: 00:51:06
  title: Zukünftige Podcast-Episoden über Docker und das Container-Ecosystem
- start: 00:52:25
...
- Backend
- DevOps
title: "#46 Welches Problem löst Docker?"
