...
talks:
  ...
  - avatar: './images/speaker/2512-alpss.png'
    ...
    to stay in an alpine lodge?  That is the spirit of ALPSS.
    In this talk, Christoph and Richard discuss why small, focused 
    conferences can offer more value than large, broad conventions.
    They will highlight their experience organizing this annual event,
    where Linux filesystem experts come to Innsbruck to hike and
    learn together. They will share practical tips on how to organize
    these gatherings and the lessons they have learned along the way.
